...
- One demo JSON file per slice. Remove the slice when the JSON lands.
...
- [ ] `20-compatibility-controls.json`
  Title: `symmetry`.
  Description: Symmetry, finite attractor search, and random seed vary as
  a stability pass for catalog-accepted Mandel controls.
